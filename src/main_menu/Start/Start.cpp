...
//     // "Back to Menu"
//     ImageLoad exitBtnTextue("assets/textures/exit.png");
//     ImGui::SetCursorPosY(ImGui::GetCursorPosY() + 20);
//     ImGui::SetCursorPosX((ImGui::GetWindowSize().x - 410) / 2);
//     ImTextureID exitBtnTexId = static_cast<ImTextureID>(static_cast<intptr_t>(exitBtnTextue.GetTextureID()));

//     if (ImGui::ImageButton("Back to Menu", exitBtnTexId,ImVec2(410,40),ImVec2(0,0),ImVec2(1,1),buttonColor)) {
//         showStart = false;
//         memset(inputBuffer, 0, sizeof(inputBuffer));
//         testStarted = false;
//         api.reset();
